...
if(isset($_POST["query"]))
{
	...
	$query = "
                  ...
                  AND user_email_status = 'verified' LIMIT 10 
              ";
...
if(isset($_POST["query_result"]))
{
    ...
    $query = "
    SELECT * FROM register_user WHERE ".$condition." AND register_user_id != '".$_SESSION["user_id"]."' 
    ...
    if($total_data > 0)
    {
        foreach($result as $row)
        {
            ...
            $confirm = Request_confirm($connect,$_SESSION['user_id'], $row['register_user_id']);
            if ($confirm=='Confirm') {
                $button=' <button type="button" name="request_button" class="btn btn-secondary"> Allready have friend</button>';
            }
            ...
            <div class="wrapper-box">
                <div class="row">
                    <div class="col-md-1 col-sm-3 col-xs-3">
                       <img src="'. Get_user_avatar_big($row["register_user_id"], $connect) .'" width="35" class="img-thumbnail img-circle user" >
                    </div>
